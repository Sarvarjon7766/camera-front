import { Bell, ChevronDown, LogOut, MapPin, Menu } from 'lucide-react'
import { useState } from 'react'

const RegionHeadNavbar = ({ toggleSidebar }) => {
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden md:flex items-center gap-1">
              <span className="text-sm font-medium text-gray-700">Region Manager</span>
          ...
          {isProfileOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-md py-1 z-30 border border-blue-50">
              <div className="px-4 py-2 text-sm text-gray-700">
                <div className="font-medium">Region Manager</div>
              </div>
              <button
...
export default RegionHeadNavbar