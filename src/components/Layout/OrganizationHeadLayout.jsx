...
const OrganizationHeadLayout = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      setIsMobile(mobile)
      setIsSidebarOpen(!mobile) // mobil holatda yopiq, desktopda ochiq
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex transition-all duration-300 relative">
      ...
      <div
        ...
        `}
      >
        {isSidebarOpen && <OrganizationSidebar />}
      </div>
...
export default OrganizationHeadLayout
